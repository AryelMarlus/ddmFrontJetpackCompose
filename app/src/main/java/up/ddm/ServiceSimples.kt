...
class ServiceSimples : Service() {
    ...
    // Handler que recebe mensagens da thread
    ...
    override fun onCreate() {
        // Inicializa a thread do serviço
    ...
    override fun onStartCommand(intent: Intent, flags: Int, startId: Int): Int {
        ...
        // Cria e exibe a notificação quando o serviço inicia
        val notification = buildNotification()
        startForeground(1, notification)

        // Envia uma mensagem para o ServiceHandler
    ...
    // Método para criar o canal de notificação (Android 8.0+)
